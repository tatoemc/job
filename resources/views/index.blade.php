...
<html lang="en">
  <head>
    <title>وكالة - عالية هولدي للتوظيف  </title>
    <meta charset="utf-8">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
						    <h3 class="mb-0 register-link"><a href="{{ url('/admin/login') }}" class="mr-3">دخول</a> - <a href="{{ route('register') }}">تسجيل</a></h3>
					    </div>
				    </div>
			    </div>
		    </div> 
        ...
        <div class="row">
            ...
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">عقودات عمل داخلية</h3>
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">عقودات عمل خارجية</h3>
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">فحوصات طبية</h3>
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                <h3 class="heading mb-3"> سيرة ذاتية احترافية</h3>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">وكالة عالية للتوظيف  </h2>
              <p>رائد التوظيف في السودان , مع تقديم خدمات التوظيف كاملة </p>
