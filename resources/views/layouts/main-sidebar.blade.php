			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{ asset('images/' . Auth::user()->images) }}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('jobs.index') }}">عرض</a></li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
							...
							</svg><span class="side-menu__label">طلبات التوظيف</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('forms.index') }}">عرض</a></li>
							<li><a class="slide-item" href="{{ route('forms.create') }}">انشاء</a></li>
						</ul>
					</li>
					@can('isAdmin')
					<li class="slide">
